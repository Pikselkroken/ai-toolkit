...
class PixlStashFetchProcess(BaseExtensionProcess):
    ...
    def run(self) -> None:
        ...
        for pic in tqdm(pictures, desc="Downloading", unit="img"):
            ...
            try:
                # pic already contains full metadata:
                # - list_pictures_for_character returns full objects from GET /pictures
                # - list_pictures_for_set fetches GET /pictures/{id}/metadata per member
                meta = pic
